...
const Index = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-game-sky-start to-game-sky-end flex flex-col items-center px-1 py-2 sm:p-4 gap-2 sm:gap-6">
      ...
      <main className="flex flex-col lg:flex-row items-start gap-2 sm:gap-6 w-full lg:max-w-6xl flex-1 min-h-0">
        <div className="flex-1 flex flex-col items-center gap-2 sm:gap-4 w-full">
          {gameState.isPaused ? (
            <div className="w-full flex-1 sm:min-h-0 sm:aspect-[4/3] sm:max-w-[800px] max-w-full bg-gradient-to-b from-game-sky-start to-game-sky-end flex items-center justify-center">
            ...
            <div 
              className="relative w-full flex-1 sm:min-h-0 sm:aspect-[4/3] sm:max-w-[800px] cursor-pointer"
              onClick={(e) => {
          ...
          {!gameState.isPaused && (
            <div className="text-center space-y-1 lg:mt-20">
